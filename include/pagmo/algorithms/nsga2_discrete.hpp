...
#ifndef PAGMO_ALGORITHMS_NSGA2_DISCRETE_HPP
#define PAGMO_ALGORITHMS_NSGA2_DISCRETE_HPP
 ...
 */
class PAGMO_DLL_PUBLIC nsga2_discrete
{
public:
     ...
     */
    nsga2_discrete(unsigned gen = 1u, double cr = 0.95, double eta_c = 10., double m = 0.01,
...
PAGMO_S11N_ALGORITHM_EXPORT_KEY(pagmo::nsga2_discrete)
